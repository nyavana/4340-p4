> **Archived 2026-05-01.** This is the pre-rewrite `README.md`, kept here for
> reference. The current top-level `README.md` is a short, status-oriented
> overview; the canonical per-feature writeups live under `doc/base-design/`,
> `doc/advanced-features/`, and `doc/weekly-reports/`. Sections below that read
> as week-by-week progress (Week 3, Week 4, Milestone 3, Post-milestone-3,
> Milestone 4, Early Tag Broadcast) are duplicated by those canonical docs.
